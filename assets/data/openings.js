...
export const openings = {
  "good-start": {
    ...
    notes: [
      "Watch both players follow the three opening rules: take the center, wake up your pieces, tuck the king away.",
      "1. e4: White's pawn marches to the middle and grabs space.",
      "1... e5: Black copies. Neither player is letting the other own the center.",
      ...
      "5... d6: Black does the same. Both sides have played a healthy opening: pawns in the center, pieces out, king safe.",
    ],
  },
  ...
  italian: {
    ...
    notes: [
      ...
      "4. c3: A sneaky pawn move preparing to build a big center with d4.",
  ...
  "ruy-lopez": {
    ...
    notes: [
      ...
      "5. O-O: Castle first. Black can grab the pawn with Nxe4, which is a real opening called the Open Ruy Lopez, and White answers d4 for a big center. Otherwise Re1 comes next and the rook watches the e-file.",
    ],
  },
  ...
  scotch: {
    ...
    notes: [
      ...
      "3... exd4: Black takes.",
      "4. Nxd4: And White takes back with the knight, which now stands proudly in the center.",
  ...
  "queens-gambit": {
    ...
    notes: [
      ...
      "1... d5: Black blocks the center.",
      "2. c4: The gambit. White offers the c-pawn to pull Black's d5 pawn away from the middle.",
      "2... e6: Black politely declines and opens a road for the black-squared bishop.",
  ...
  sicilian: {
    ...
    notes: [
      "The most popular answer to 1. e4 in the whole world. Black refuses to copy White and fights for the center sideways.",
      "1. e4",
      ...
      "3. d4: White opens the center.",
      "3... cxd4: The Sicilian trade: a wing pawn for a center pawn. Black is happy with that deal.",
      "4. Nxd4",
  ...
  french: {
    ...
    notes: [
      "The French is a fortress. Black builds a wall of pawns and waits for a chance to knock White's center down.",
      "1. e4",
      "1... e6: Quiet, but it prepares d5 next move with support.",
      "2. d4: White happily builds a big center.",
      "2... d5: There it is. Black challenges e4 straight away.",
      "3. Nc3: Defending the e4 pawn.",
      "3... Nf6: Attacking it again.",
      "4. e5: White pushes past and gains space. The center locks up.",
      "4... Nfd7: The knight steps back to help attack the d4 pawn later with c5.",
      "5. f4: White builds a big pawn wall. One warning: the French leaves Black's white-squared bishop stuck behind the e6 pawn. Finding a job for that bishop is Black's whole plan.",
    ],
  },
  ...
  "caro-kann": {
    ...
    notes: [
      ...
      "3. Nc3: Defending e4.",
      "3... dxe4: Black trades in the center.",
      "4. Nxe4",
      "4... Bf5: Here is the difference. The white-squared bishop gets OUT before the pawns lock it in.",
